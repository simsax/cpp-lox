...
namespace stmt {
	...
	struct Class : public Stmt {
		Class(const Token& name, std::unique_ptr<expr::Variable> superClass,
			MethodVec methods, MethodVec classMethods)
			: m_Name(name)
		...
		Token m_Name;
		std::unique_ptr<expr::Variable> m_SuperClass;
		MethodVec m_Methods;
	...
	inline std::any Block::Accept(Visitor& visitor) { return visitor.VisitBlock(this); }

	inline std::any Expression::Accept(Visitor& visitor) { return visitor.VisitExpression(this); }

	inline std::any Print::Accept(Visitor& visitor) { return visitor.VisitPrint(this); }

	inline std::any Var::Accept(Visitor& visitor) { return visitor.VisitVar(this); }

	inline std::any If::Accept(Visitor& visitor) { return visitor.VisitIf(this); }

	inline std::any While::Accept(Visitor& visitor) { return visitor.VisitWhile(this); }

	inline std::any Function::Accept(Visitor& visitor) { return visitor.VisitFunction(this); }

	inline std::any Return::Accept(Visitor& visitor) { return visitor.VisitReturn(this); }

	inline std::any Class::Accept(Visitor& visitor) { return visitor.VisitClass(this); }

	inline std::any For::Accept(Visitor& visitor) { return visitor.VisitFor(this); }

	inline std::any Jump::Accept(Visitor& visitor) { return visitor.VisitJump(this); }
}
